...
export default function PricingSection() {
  const plans = [
    ...
    },
    {
      ...
      price: '₦10,000',
      period: 'one-time payment',
      description: 'Specialized career-focused training with dedicated mentorship and exclusive opportunities.',
      features: [
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-10 border-2 border-purple-200">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Complete any program, put in the work, and you’ll have the skills, portfolio, 
