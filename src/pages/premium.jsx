...
export default function PricingSection() {
  const plans = [
    ...
    },
    {
      ...
      description:
        "Full access to program, projects, mentorship, and career support.",
      features: [
    ...
    },
    {
      ...
      period: "one-time payment",
      description:
        "Specialized career-focused training with dedicated mentorship and exclusive opportunities.",
      features: [
        ...
        {
          text: "Career roadmap & specialization certification",
          included: true,
        },
        { text: "Mock interview preparation", included: true },
        {
          text: "Job referral to partner companies",
          included: true,
          highlight: true,
        },
        { text: "Lifetime alumni network access ", included: true },
        { text: "Lifetime alumni support & exclusive events", included: true },
      ],
      highlighted: true,
      color: "gray",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="md:text-xl text-[16px] text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Try for free, go premium, or join our exclusive Premium+ Track for
              specialized mentorship and career growth.
            </p>
          </div>
                ...
                >
                  {plan.badge && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                      <div
                        className={`bg-gradient-to-r ${colors.gradient} text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg`}
                      >
                        {plan.badge}
                      </div>
                    </div>
                  ...
                  >
                    {/* Header */}
                    <div
                      className={`${plan.highlighted ? colors.bg : "bg-gray-50"} p-8 border-b ${plan.highlighted ? colors.border : "border-gray-200"}`}
                    >
                      ...
                      <ul className="space-y-4 mb-8">
                        {plan.features.map((feature, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            {feature.included ? (
                              <div
                                className={`w-6 h-6 rounded-full bg-gradient-to-br ${colors.gradient} flex items-center justify-center flex-shrink-0 mt-0.5`}
                              >
                            ...
                            <span
                              className={`${feature.included ? "text-gray-700" : "text-gray-400 line-through"} ${feature.bold ? "font-semibold" : ""} ${feature.highlight ? "font-semibold text-green-600" : ""}`}
                            >
                              {feature.text}
                            </span>
                          </li>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-10 border-2 border-purple-200">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Complete any program, put in the work, and you’ll have the
                skills, portfolio, and confidence to land your dream role. We’ll
                support you with mentorship and job readiness every step of the
                way.
              </p>
