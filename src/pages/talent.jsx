  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/hire-inquiry`,
        {
          method: "POST",
      ...
      toast.success("❌ Network error. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div>
      ...
      <div className="flex items-center justify-center lg:p-20 md:p-18 sm:p-16 p-14 xl:p-24 bg-[#FAFAFA] sm:min-h-[80vh]">
        <div className=" text-center">
          ...
          <p className="m-0 md:w-[70%] mx-auto xl:text-[20px] lg:text-[18px] md:text-[17px] text-[15px] text-gray-500">
            Find experienced, job-ready professionals who can join your team and
            start contributing immediately. Hire faster, smarter, and better.
          </p>
          ...
          <div className="mt-6 ">
            <Button
              ...
              className="bg-neutral-600 hover:bg-gray-700 text-white font-semibold lg:py-5 md:px-8 md:py-4 px-10 py-5 lg:px-10 rounded-lg shadow-md transition duration-300"
            >
              Hire Talent
            </Button>
          </div>
      ...
      <div className="my-10 sm:mx-5 mx-4 sm:flex items-center justify-center gap-10">
        ...
        <div
          data-aos="fade-in"
          className="bg-neutral-300 py-10 w-[330px] h-[400px] sm:h-[400px] sm:mx-0 mx-auto sm:w-[400px] rounded-sm p-5 text-start "
        >
          ...
          <p className="text-sm mt-3">
            Hire vetted, job-ready professionals across design, development, and
            product, trained to deliver results and drive innovation.
          </p>
        </div>
        ...
        <div
          ...
          className="sm:w-[400px] w-[330px] h-[400px] sm:h[400px] bg-gray-900 text-white rounded-sm p-6 flex flex-col sm:mx-0 mx-auto justify-center sm:mt-0 mt-6"
        >
          ...
          <ul className="space-y-3 text-sm leading-relaxed">
            <li>
              ✅ <span className="font-semibold">Pre-vetted professionals</span>{" "}
              trained through real-world projects.
            </li>
            <li>
              ⚡ <span className="font-semibold">Faster onboarding</span>,
              talents who understand agile workflows.
            </li>
            <li>
              💡{" "}
              ...
              , ready to deliver business impact.
            </li>
            <li>
              🌍{" "}
              <span className="font-semibold">
      ...
      <div className="bg-gray-900 text-white py-20 text-center">
        ...
        <p className="text-gray-300 max-w-xl mx-auto mb-8">
          Whether you’re building your first product or scaling an existing one,
          our talents can help you get there faster. Let’s connect and create
          something exceptional together.
        </p>
        <Button
          onClick={handleScroll}
          className="bg-white text-gray-900 hover:bg-gray-200 font-semibold px-8 py-4 rounded-md"
        >
          Get in Touch
        </Button>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center bg-[#F3F3F3] py-20 px-10 gap-10">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-gray-600 mb-6 max-w-md">
            Let’s help you find top-tier designers, developers, and product
            managers trained to deliver excellence from day one. Fill out the
            form to connect with us, we’ll match you with the perfect talent for
            your team.
          </p>
        ...
        <div
          id="contact-us"
          className="lg:w-1/2 w-full bg-white shadow-md rounded-lg p-8"
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
                disabled={loading}
              className="bg-gray-900 hover:bg-gray-800 text-white w-full py-3 rounded-md font-semibold"
              type="submit"
            >
