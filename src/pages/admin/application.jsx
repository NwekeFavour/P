    ...
    <AdminLayout>
      <div className="space-y-6 pb-10 px-4 md:px-0">
        ...
        <Card className="border-none shadow-sm rounded-[1.5rem] md:rounded-[2rem] overflow-hidden bg-white">
                    ...
                    <Badge
                      className={
                        app.status === "Approved"
                          ...
                          : "bg-amber-50 text-amber-600 ml-auto"
                      }
                    >
                      {app.status}
                    </Badge>
                  ...
                  paginatedApps.map((app) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5">
                        {app.package === "Premium" ? (
                          <Badge className="bg-amber-50 text-amber-600 border-amber-100 font-black text-[10px]">
                            PREMIUM
                          </Badge>
                        ) : (
                          <Badge
          ...
          {/* Pagination */}
          {!loading && filteredApps.length > ITEMS_PER_PAGE && (
            <div className="flex items-center justify-between px-6 md:px-8 py-4 border-t border-gray-50">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="h-8 w-8 flex items-center justify-center rounded-xl text-gray-400 hover:bg-gray-100 disabled:opacity-30 disabled:cursor-not-allowed transition-all font-bold text-sm"
                >
                  ‹
                </button>
...
function MobileActionsDropdown({ app, onStatusChange }) {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="rounded-2xl bg-white! w-52 p-2 shadow-2xl border-gray-100"
      >
        {/* Approve Action */}
        <DropdownMenuItem
