...
export default function HowItWorksSection() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Complete a short technical assessment to gauge your problem-solving skills. Pass that, and you\'ll have a 15-minute video interview with our team.',
      duration: '1 week',
      color: 'purple'
    },
    {
    ...
    },
    {
      ...
      description: 'Graduate with a portfolio of production projects, industry certificate, and direct introductions to hiring companies. Start earning ₦200k-₦500k monthly.',
      duration: 'Lifetime',
      color: 'orange'
    }
  ];
    ...
    <div className="bg-gradient-to-br from-white via-gray-50 to-white py-20 px-6">
      <div className="max-w-7xl mx-auto">
              ...
              return (
                <div key={index} className="relative">
                  ...
                  <div className={`hidden lg:grid grid-cols-2 gap-12 items-center ${isEven ? '' : 'direction-rtl'}`} data-aos="fade-up" data-aos-duration="1000" data-aos-delay={index * 200}>
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          {isEven && (
                            <>
                              ...
                              <div className={`text-5xl font-bold ${colors.text} opacity-20`}>
                                {step.number}
                              </div>
                            </>
                          )}
                    ...
                    {/* Icon Side */}
                    <div className={`${isEven ? 'col-start-2' : 'col-start-1'} flex ${isEven ? 'justify-start pl-12' : 'justify-end pr-12'}`}>
                      <div className="relative">
                        <div className={`absolute inset-0 bg-gradient-to-br ${colors.gradient} rounded-3xl blur-xl opacity-30`} />
                        <div className={`relative w-24 h-24 bg-gradient-to-br ${colors.gradient} rounded-3xl flex items-center justify-center shadow-2xl`}>
                  ...
                  <div className="lg:hidden">
                    <div className="flex gap-6">
                      ...
                      <div className="flex-shrink-0">
                        <div className="relative">
                          <div className={`absolute inset-0 bg-gradient-to-br ${colors.gradient} rounded-2xl blur-lg opacity-30`} />
                          <div className={`relative w-16 h-16 bg-gradient-to-br ${colors.gradient} rounded-2xl flex items-center justify-center shadow-xl`}>
                            <Icon className="w-8 h-8 text-white" />
                          </div>
                        </div>
                        {index !== steps.length - 1 && (
                          <div className="w-1 h-full bg-gradient-to-b from-blue-200 to-purple-200 mx-auto mt-4" style={{ minHeight: '60px' }} />
                        )}
                      </div>
                      ...
                      <div className="flex-1 pb-8">
                        <div className="flex items-center gap-3 mb-3">
                          <div className={`text-3xl font-bold ${colors.text} opacity-20`}>
                            {step.number}
                          </div>
                          <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4 text-gray-500" />
                  ...
                  <div className="hidden lg:block absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <div className={`w-4 h-4 ${colors.bg} rounded-full border-4 border-white shadow-lg`} />
                  </div>
                </div>
              );
            })}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <h4 className="text-lg font-bold text-white mb-2">Earning Opportunities</h4>
            <p className="text-gray-400 text-sm">
                Connect with internships, projects & jobs — many earn ₦150k–₦500k within months.
            </p>
            </div>
            ...
            <p className="text-gray-400 text-sm">
                Industry-recognized certificate to boost your credibility with employers.
            </p>
            </div>
            ...
            <p className="text-gray-400 text-sm">
                Graduate with 3–5 production-ready projects to showcase your skills.
            </p>
            </div>
            ...
            <p className="text-gray-400 text-sm">
                Join 5,000+ peers, alumni & mentors opening doors to opportunities.
            </p>
            </div>
        </div>
        </div>
